...
const SpotLightAberration2 = ({ position, target, intensity, maxDistance, scaleAngle, scaleAberration, cameraRef }) => {
  const position1 = [
    position[0],
    position[1] + 5,
  ...
  const position2 = [
    position[0] + 0.707 * scaleAberration,
    position[1] + 5,
...
export default SpotLightAberration2;
